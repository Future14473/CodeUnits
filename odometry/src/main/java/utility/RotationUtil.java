...
public class RotationUtil {
     ...
     */
    //XXX: it seems to me this is simply angleNorm(angle1-angle2), where angleNorm is a function that normalizes
    // an angle between -180 to 180 degrees
    // Also, it might be best to always stick with Radians
    public static double turnLeftOrRight(double robotAngle, double destAngle, int cycleSize) {
        // convert to 0-360 range
        robotAngle = mod(robotAngle, 360);
        destAngle = mod(destAngle, 360);
